        ...
        <section className="book-consultation">
          <div className="book-consultation__container">
            <div className="book-consultation__left">
              <span className="book-consultation__pill">Session With Our CEO</span>
              <h1 className="book-consultation__title">BOOK YOUR CONSULTATION SESSION</h1>
              <p className="book-consultation__subtitle">
                Reserve a focused strategy session with our CEO to map your AI product roadmap,
                identify high-impact opportunities, and define execution milestones.
              </p>
              ...
              {isSubmitted ? (
                <div className="book-success">
                  ...
                  <p>
                    ...
                    <strong>{selectedTime}</strong> ({selectedMode}). Our team will contact you
                    shortly on <strong>{form.email}</strong> for confirmation.
                  </p>
                </div>
              ) : (
                <form className="book-form" onSubmit={handleSubmit}>
                  ...
                  <label htmlFor="goals">What would you like to discuss?</label>
                  <textarea
                    id="goals"
                    name="goals"
                    rows="4"
